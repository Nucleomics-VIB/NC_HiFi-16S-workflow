...
(forked on 2024-06-28 from https://github.com/PacificBiosciences/HiFi-16S-workflow in order to slightly alter code and add custom scripts; See [README-2](https://github.com/Nucleomics-VIB/NC_HiFi-16S-workflow/edit/main/READM2.md) for more details)
