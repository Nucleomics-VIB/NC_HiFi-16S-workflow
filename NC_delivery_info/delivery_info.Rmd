...
# from R730
wd <- "/opt/biotools/HiFi-16S-workflow"
...
**Note:** Some of the default options might not be ideal for every biological question and project. If a new analysis needs be done with other parameters, the user can contact us for a quote or use the HiFi-16S-workflow on their own bioinformatics infrastructure ^[https://github.com/PacificBiosciences/HiFi-16S-workflow].
...
The version of the **HiFi-16S-workflow** used here was **v0.9** ^[https://github.com/PacificBiosciences/HiFi-16S-workflow].

**Table 1:** list of analysis arguments accepted by the HiFi-16S-workflow
...
```{bash run_HiFi-16S-workflow_template.sh}

#!/bin/bash

# script: run_HiFi-16S-workflow.sh
# run pacbio HiFi-16S-workflow
# SP@NC, 2023/10/23, v1.2
# depends on modified nextflow.config file as described in:
# https://github.com/PacificBiosciences/HiFi-16S-workflow/issues/39
